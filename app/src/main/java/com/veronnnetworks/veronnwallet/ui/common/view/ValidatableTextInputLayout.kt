...
class ValidatableTextInputLayout @JvmOverloads constructor(
    ...
    init {
        ...
        triggerAfterValidation =
            a.getBoolean(R.styleable.ValidatableTextInputLayout_triggerAfterValidation, false)
        validationInterval =
            a.getInteger(R.styleable.ValidatableTextInputLayout_interval, 300).toLong()
        ...
        if (!triggerAfterValidation) {
            ...
            if (hasFocus) {
                ...
                if (shouldValidateOnFocusChanged) {
                    compositeDisposable.clear()
                    compositeDisposable.add(
                        validateAsCompletable().subscribe(
